...
public static class FailConditionEndpoint
{
    public static void Map(RouteGroupBuilder group)
    {
        group.MapPatch("/{id:guid}/fail", HandleAsync)
            .WithName("FailCondition")
            .WithSummary("Mark a condition failed.")
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = await sender.Send(new FailConditionCommand(id, ownerUserId), cancellationToken);
